...
# %%
run_base_name = 'run_2019-06-18_17-40-56_'

init_dic = dict(
    DATE_START=dt.date(2017, 12, 8),
    DATE_END=dt.date(2017, 12, 8),
    ...
    WRFOUT_PATH='/proj/atm/saltena/runs/run_2019_05_15/wrf_compressed',
