...
# %%
run_base_name = 'run_2020-01-03_19-36-06_'

init_dic = dict(
    DATE_START=dt.date( 2017 , 12 , 6 ) ,
    DATE_END=dt.date( 2018 , 5 , 31 ) ,
    HOURS_BACK_IN_TIME=24 ,  # possitive,
    RUN_BASE_NAME=run_base_name ,
    RUN_BASE_PATH='/Users/diego/flexpart_management/'
                  'flexpart_management/runs_config_dir' ,
    RUN_BASE_PATH_TAITO='/homeappl/home/aliagadi/wrk/'
                        'DONOTREMOVE/flexpart_management_data/runs/' ,
    WRFOUT_PATH='/proj/atm/saltena/runs/run_2019_05_15/wrf' ,
    FLX_INPUT_TEMPL_PATH='/Users/diego/flexpart_management/'
                         'flexpart_management/runs_config_dir/' \
                         + run_base_name + '/flex_input_templ' ,
    RUN_TEMPL_PATH='/Users/diego/flexpart_management/'
                   'flexpart_management/runs_config_dir/' \
