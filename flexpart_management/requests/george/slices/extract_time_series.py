...
def main():
    ...
    # %%
    # %%
    var_list = ['eth','tk','wa','va','ua','th','rh','QVAPOR']
    ts_out_list = []
    ...
    data_path = '/Users/diego/flexpart_management/flexpart_management/requests/george/data'
    df.to_csv(pjoin(
        data_path,
        'time_series_for_selected_values_at_chc_wrf.csv'
    ))
    ...
    # %%
    ts_out.to_netcdf(pjoin(data_path,
